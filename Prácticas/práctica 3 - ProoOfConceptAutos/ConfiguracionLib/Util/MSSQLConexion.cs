...
namespace ConfiguracionLib.Util
{
    ...
    {        
        ...
        {        
            ...
            string str = @"Data Source=SERVKEY-XPS\SQLEXPRESS;initial catalog=TSCI;persist security info=True;user id=sa;password=123456";//SERVKEY-XPS\SQLSERVER;Initial Catalog=DBControlEscolar;User ID=tsci;Password=tsci@@~~";           
            try
            {
